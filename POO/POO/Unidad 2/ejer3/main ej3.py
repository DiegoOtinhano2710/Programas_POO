...
if __name__ == '__main__':
    ...
    while (confirmar == 'si'):
        ...
        if opcion == '1':
            ...
            print("el total de esa sucursal es: {}".format(Gestorvent.total_sucursal(suc-1)))
        elif opcion == '3':
            dia=int(input("ingresar dia de la semana (1-7): "))
            print("la sucursal que más facturó el día {} fue {}".format(dia, Gestorvent.max_dia(dia-1)))
        elif opcion == '4':
